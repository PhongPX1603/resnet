...
def Resnet101(img_channels=3, num_classes=1000):
	return Resnet(block=block, layers=[3, 4, 23, 3], image_channels=img_channels, num_classes=num_classes)

def Resnet152(img_channels=3, num_classes=1000):
	return Resnet(block=block, layers=[3, 8, 36, 3], image_channels=img_channels, num_classes=num_classes)